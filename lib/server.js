...
const server = _http.default.createServer(_app.default); // Create an HTTP server using the Express app
const io = new _socket.Server(server); // Create a Socket.IO server and attach it to the HTTP server
